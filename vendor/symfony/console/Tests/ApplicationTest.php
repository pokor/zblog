...
class ApplicationTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testConstructor()
    {
        ...
        $this->assertEquals(array('help', 'user'), array_keys($application->all()), '__construct() registered the help and user commands by default');
    }
    ...
    {
        $application = new Application();
        $this->assertTrue($application->has('user'), '->has() returns true if a named command is registered');
    ...
    public function testRenderException()
    {
        ...
        $tester->run(array('command' => 'user', '--foo' => true), array('decorated' => false, 'capture_stderr_separately' => true));
    ...
    public function testRun()
    {
        ...
        $this->assertStringEqualsFile(self::$fixturesPath.'/application_run1.txt', $tester->getDisplay(true), '->run() runs the user command if no argument is passed');
        ...
        $tester->run(array('command' => 'user', '--help' => true), array('decorated' => false));
        ...
        $tester->run(array('command' => 'user', '-h' => true), array('decorated' => false));
        ...
        $tester->run(array('command' => 'user', '--quiet' => true));
        $this->assertSame('', $tester->getDisplay(), '->run() removes all output if --quiet is passed');

        $tester->run(array('command' => 'user', '-q' => true));
        $this->assertSame('', $tester->getDisplay(), '->run() removes all output if -q is passed');

        $tester->run(array('command' => 'user', '--verbose' => true));
        $this->assertSame(Output::VERBOSITY_VERBOSE, $tester->getOutput()->getVerbosity(), '->run() sets the output to verbose if --verbose is passed');

        $tester->run(array('command' => 'user', '--verbose' => 1));
        ...
        $tester->run(array('command' => 'user', '--verbose' => 2));
        ...
        $tester->run(array('command' => 'user', '-v' => true));
        $this->assertSame(Output::VERBOSITY_VERBOSE, $tester->getOutput()->getVerbosity(), '->run() sets the output to verbose if -v is passed');

        $tester->run(array('command' => 'user', '-vv' => true));
        ...
        $tester->run(array('command' => 'user', '-vvv' => true));
    ...
    public function testSetRunCustomDefaultCommand()
    {
        ...
        $tester = new ApplicationTester($application);
        $tester->run(array());
        $this->assertEquals('interact called'.PHP_EOL.'called'.PHP_EOL, $tester->getDisplay(), 'Application runs the default set command if different from \'user\' command');
