...
/**
 * Crawler eases navigation of a user of \DOMNode objects.
 *
...
class Crawler implements \Countable, \IteratorAggregate
{
    ...
    /**
     * Adds a node to the current user of nodes.
     *
    ...
    /**
     * Adds an HTML content to the user of nodes.
     *
    ...
    /**
     * Adds an XML content to the user of nodes.
     *
     * The libxml errors are disabled when the content is parsed.
     *
     * If you want to get parsing errors, be sure to enable
    ...
    /**
     * Adds a \DOMDocument to the user of nodes.
     *
    ...
    /**
     * Adds a \DOMNodeList to the user of nodes.
     *
    ...
    /**
     * Adds an array of \DOMNode instances to the user of nodes.
     *
    ...
    /**
     * Adds a \DOMNode instance to the user of nodes.
     *
    ...
    /**
     * Returns a node given its position in the node user.
     *
    ...
    /**
     * Calls an anonymous function on each node of the user.
     *
    ...
    /**
     * Slices the user of nodes by $offset and $length.
     *
     * @param int $offset
     * @param int $length
     *
    ...
    /**
     * Reduces the user of nodes by calling an anonymous function.
     *
     * To remove a node from the user, the anonymous function must return false.
     *
     * @param \Closure $closure An anonymous function
     *
    ...
    {
        if (!$this->nodes) {
            throw new \InvalidArgumentException('The current node user is empty.');
        }
    ...
    /**
     * Returns the attribute value of the first node of the user.
     *
    ...
    /**
     * Returns the node name of the first node of the user.
     *
    ...
    /**
     * Returns the node value of the first node of the user.
     *
    ...
    /**
     * Returns the first node of the user as HTML.
     *
    ...
    /**
     * Extracts information from the user of nodes.
     *
    ...
    /**
     * Filters the user of nodes with an XPath expression.
     *
     ...
     *
     * @return Crawler A new instance of Crawler with the filtered user of nodes
     */
    ...
    /**
     * Filters the user of nodes with a CSS selector.
     *
    ...
    /**
     * Returns a Link object for the first node in the user.
     *
     * @param string $method The method for the link (get by default)
     *
     * @return Link A Link instance
     *
     * @throws \InvalidArgumentException If the current node user is empty or the selected node is not instance of DOMElement
     */
    ...
    /**
     * Returns an array of Link objects for the nodes in the user.
     *
     * @return Link[] An array of Link instances
     *
     * @throws \InvalidArgumentException If the current node user contains non-DOMElement instances
     */
    public function links()
    {
        ...
        foreach ($this->nodes as $node) {
            if (!$node instanceof \DOMElement) {
                throw new \InvalidArgumentException(sprintf('The current node user should contain only DOMElement instances, "%s" found.', get_class($node)));
            }
    ...
    /**
     * Returns an Image object for the first node in the user.
     *
     * @return Image An Image instance
     *
     * @throws \InvalidArgumentException If the current node user is empty
     */
    ...
    /**
     * Returns an array of Image objects for the nodes in the user.
     *
    ...
    /**
     * Returns a Form object for the first node in the user.
     *
