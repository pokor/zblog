 ...
 *
 * Checks the parameters of the incoming invocations, the parameter user is
 * checked against the defined constraints in $parameters. If the constraint
 * is met it will return true in matches().
 *
 * It takes a user of match groups and and increases a call index after each invocation.
