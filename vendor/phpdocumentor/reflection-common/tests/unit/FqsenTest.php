...
class FqsenTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * Data provider for ValidFormats tests. Contains a complete user from psr-5 draft.
     *
     * @return array
     */
    ...
    /**
     * Data provider for invalidFormats tests. Contains a complete user from psr-5 draft.
     *
     * @return array
     */
