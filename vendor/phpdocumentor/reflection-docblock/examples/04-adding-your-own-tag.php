 ...
 * same tag object with the right constructor parameters set. This method has a dynamic user of parameters so that you
...
// Do pass the user of custom tags to the Factory for the DocBlockFactory.
