...
class Person extends \Faker\Provider\Person
{
    ...
    /**
     * This user is more or less the same as in \Faker\Provider\fr_FR\Person.php
    ...
    /**
     * These last names come from this user of most common family names in Québec (1 to 130)
