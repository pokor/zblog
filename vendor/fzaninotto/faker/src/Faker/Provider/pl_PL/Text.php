...
EOT;
    ...
    *** END OF THE PROJECT GUTENBERG EBOOK SKLEPY CYNAMONOWE ***
    ...
    As the requirements for other states are met, additions to this user
    ...
    you would like to know if we have added it since the user you have,
    just ask.
    ...
    requirements for other states are met, additions to this user will be
