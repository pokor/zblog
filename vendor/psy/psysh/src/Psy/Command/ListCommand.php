...
class ListCommand extends ReflectingCommand implements PresenterAware
{
    ...
    protected function configure()
    {
        $this
            ->setName('ls')
            ->setAliases(array('user', 'dir'))
            ->setDefinition(array(
                new InputArgument('target', InputArgument::OPTIONAL, 'A target class or object to user.', null),
...
Called without options, this will return a user of variables currently in scope.

If a target object is provided, user properties, constants and methods of that
target. If a class, interface or trait name is passed instead, user constants
...
HELP
    ...
    /**
     * Write the user items to $output.
     *
