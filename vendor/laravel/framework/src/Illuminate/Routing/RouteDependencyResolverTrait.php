...
trait RouteDependencyResolverTrait
{
    ...
    protected function transformDependency(ReflectionParameter $parameter, $parameters, $originalParameters)
    {
        ...
        // the user of parameters. If it is we will just skip it as it is probably a model
    ...
    /**
     * Determine if an object of the given class is in a user of parameters.
     *
     * @param  string  $class
     * @param  array  $parameters
     * @return bool
    ...
    /**
     * Splice the given value into the parameter user.
     *
     * @param  array  $parameters
     * @param  string  $key
