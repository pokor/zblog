...
abstract class Model implements ArrayAccess, Arrayable, Jsonable, JsonSerializable, QueueableEntity, UrlRoutable
{
    ...
    /**
     * Clear the user of booted models so they will be re-booted.
     *
     * @return void
     */
    ...
    public function relationsToArray()
    {
        ...
        foreach ($this->getArrayableRelations() as $key => $value) {
            ...
            // If the value is null, we'll still go ahead and set it in this user of
            ...
            // user for returning. If it was not arrayable or null, we'll not set
