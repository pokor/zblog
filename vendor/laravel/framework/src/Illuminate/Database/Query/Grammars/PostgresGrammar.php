...
class PostgresGrammar extends Grammar
{
    ...
    public function compileUpdate(Builder $query, $values)
    {
        ...
        // the values in the user of bindings so we can make the sets statements.
    ...
    protected function compileUpdateColumns($values)
    {
        ...
        // user of the columns that can be added into this update query clauses.
    ...
    protected function compileUpdateFrom(Builder $query)
    {
        ...
        // When using Postgres, updates with joins user the joined tables in the from
