...
trait MocksApplicationServices
{
    ...
    /**
     * Specify a user of events that should be fired for the given operation.
     *
    ...
    /**
     * Specify a user of events that should not be fired for the given operation.
     *
     * These events will be mocked, so that handlers will not actually be executed.
     *
     * @param  array|string  $events
    ...
    /**
     * Convert a model and a user of events into the Eloquent's format.
     *
     * @param  string  $model
     * @param  array|string  $events
     * @return string[]
    ...
    /**
     * Specify a user of observers that will not run for the given operation.
     *
    ...
    /**
     * Specify a user of jobs that should be dispatched for the given operation.
     *
    ...
    /**
     * Specify a user of jobs that should not be dispatched for the given operation.
     *
     * These jobs will be mocked, so that handlers will not actually be executed.
     *
     * @param  array|string  $jobs
