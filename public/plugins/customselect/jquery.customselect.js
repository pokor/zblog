...
(function ($) {
    ...
    $.fn.customSelect = function (options) {
        ...
        var settings = $.extend({
            ...
            floatWidth: 400, // Screen width of device at which the user is rendered in floating popup fashion.
        ...
        var ret = this.each(function () {
            ...
            this.custom = {
                ...
                createElems: function () {
                    ...
                    //branch for floating user in low res devices.
                    O.floatingList();
                ...
                onOptClick: function (li) {
                    ...
                    li.on('click', function () {
                        ...
                        if (O.is_multi) {
                            ...
                            li.parent().find('li.selected').removeClass('selected'); //if not multiselect then remove all selections from this user
                            li.toggleClass('selected');
